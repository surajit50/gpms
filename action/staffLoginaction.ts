...
import { DEFAULT_STAFFLOGIN_REDIRECT } from "@/routes";
...
export const staffLoginaction = async (values: z.infer<typeof LoginSchema>) => {
  ...
  try {
    await signIn("credentials", {
      email,
      password,
      redirectTo: DEFAULT_STAFFLOGIN_REDIRECT,
    });
  } catch (error) {
