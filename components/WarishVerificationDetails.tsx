...
type WarishApplicationWithDetails = WarishApplication & {
  warishDetails: WarishDetail[];
  WarishDocument: WarishDocument[];
};

interface WarishVerificationDetailsProps {
  application: WarishApplicationWithDetails;
}
...
export const WarishVerificationDetails = ({
  application,
}: WarishVerificationDetailsProps) => {
  return (
    <div className="container mx-auto p-4 md:p-6 space-y-6 max-w-7xl mt-6">
      {/* Header */}
