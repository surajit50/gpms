...
export const AgrementCertificate = ({ agrement }: { agrement: Agreement }) => {
  ...
  const handleGeneratePDF = async () => {
    ...
    )}, between the Pradhan, ${gpname}, ${gpaddress}. of West Bengal,  hereinafter “The First Party” of the one part and  ${
      agrement.acceptagency.agencydetails.agencyType=="FARM" ? `${agrement.acceptagency.agencydetails.name} (${agrement.acceptagency.agencydetails.proprietorName})` : agrement.acceptagency.agencydetails.name
    }, ${
