...
import PDFGeneratorComponent from "@/components/PrintTemplet/comparative-statement";
import { formatDate } from "@/utils/utils";
export const columns: ColumnDef<comparativeStatementProps>[] = [
  {
  ...
  {
    id: "actions",
    cell: ({ row }) => <PDFGeneratorComponent comparativeStatement={row.original} />,
  },
];
