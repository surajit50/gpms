...
import { WorksDetail, NitDetails, ApprovedActionPlanDetails, Bidagency, AgencyDetails, AOC } from "@prisma/client";

export type WorksDetailWithRelations = WorksDetail & {
  nitDetails: NitDetails;
  ApprovedActionPlanDetails: ApprovedActionPlanDetails; // Lowercase 'a'
...
// Bidder Types
export type Bidder = Prisma.AgencyDetailsGetPayload<{}>
